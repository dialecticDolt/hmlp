...
def SpectralCluster(PyGOFMM.KernelMatrix K, int nclasses, int[:] gids, init="random", eigensolver='ks', slack=0, itrs=40):
    ...
    output  = KMeans(comm, spectral_points, nclasses, maxiter=itrs, init=init)
