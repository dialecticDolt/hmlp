...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/workspace/will/dev/hmlp/build/new_python/lib/python3.4/site-packages/numpy/core/include/numpy/arrayobject.h",
            "/workspace/will/dev/hmlp/build/new_python/lib/python3.4/site-packages/numpy/core/include/numpy/ufuncobject.h",
            "/workspace/will/dev/hmlp/frame/base/DistData.hpp",
            "/workspace/will/dev/hmlp/frame/containers/KernelMatrix.hpp",
            "/workspace/will/dev/hmlp/frame/containers/VirtualMatrix.hpp",
            "/workspace/will/dev/hmlp/gofmm/gofmm.hpp",
            "/workspace/will/dev/hmlp/gofmm/gofmm_mpi.hpp",
            "/workspace/will/dev/hmlp/gofmm/igofmm_mpi.hpp",
            "/workspace/will/dev/hmlp/gofmm/tree_mpi.hpp",
            "/workspace/will/dev/hmlp/include/hmlp.h",
            "/workspace/will/dev/hmlp/python/custom/user_defined.cpp"
        ],
        "extra_compile_args": [
            "-std=c++11",
            "-O3",
            ...
            "-mavx",
            "-DHMLP_USE_MPI",
            "-I/opt/apps/sysnet/intel/17.0/mkl/include"
        ],
        "extra_link_args": [
            "-lpthread",
            "-qopenmp",
            "-mkl=parallel",
            "-lm",
            "-L/opt/apps/sysnet/intel/17.0/mkl/lib/intel64/",
            "-lmkl_rt",
            "-lpthread",
            "-lm",
            "-ldl",
        ...
        "include_dirs": [
            "/workspace/will/dev/hmlp/build/new_python/lib/python3.4/site-packages/numpy/core/include",
            "/workspace/will/dev/hmlp/include",
            "/workspace/will/dev/hmlp/gofmm",
            "/workspace/will/dev/hmlp/frame",
            "/workspace/will/dev/hmlp/frame/base",
            "/workspace/will/dev/hmlp/frame/primitives",
            "/workspace/will/dev/hmlp/frame/containers",
            "/workspace/will/dev/hmlp/kernel/reference",
            "/workspace/will/dev/hmlp/kernel/x86_64/haswell",
            "/opt/apps/sysnet/intel/17.0/mkl/include",
            "/workspace/will/dev/hmlp/build/new_python/lib/python3.4/site-packages/numpy/core/include"
        ],
        "language": "c++",
        "libraries": [
        ...
        "library_dirs": [
            "/workspace/will/dev/hmlp/build/lib",
            "/opt/apps/sysnet/intel/17.0/mkl/include",
            "/opt/apps/sysnet/intel/17.0/mkl/lib/intel64"
        ],
        "name": "pygofmm.mltools.algorithms",
        ...
        "sources": [
            "pygofmm/mltools/algorithms.pyx"
        ]
    },
    "module_name": "pygofmm.mltools.algorithms"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pygofmm__mltools__algorithms
#define __PYX_HAVE_API__pygofmm__mltools__algorithms
/* Early includes */
#include "mpi.h"
#include "ios"
#include "new"
#include "stdexcept"
#include "typeinfo"
#include "/workspace/will/dev/hmlp/include/hmlp.h"
#include <vector>
#include <string.h>
#include <string>
#include "/workspace/will/dev/hmlp/frame/containers/VirtualMatrix.hpp"
#include "/workspace/will/dev/hmlp/gofmm/gofmm.hpp"
#include <utility>
#include <map>
#include "/workspace/will/dev/hmlp/frame/base/DistData.hpp"
#include "/workspace/will/dev/hmlp/frame/containers/KernelMatrix.hpp"
#include "/workspace/will/dev/hmlp/gofmm/tree_mpi.hpp"
#include "/workspace/will/dev/hmlp/gofmm/gofmm_mpi.hpp"
#include "/workspace/will/dev/hmlp/gofmm/igofmm_mpi.hpp"
#include <stdio.h>
#include "numpy/arrayobject.h"
#include "numpy/ufuncobject.h"
#include "/workspace/will/dev/hmlp/python/custom/user_defined.cpp"
#include <math.h>
#include <stdlib.h>
#include "pythread.h"
#include "pystate.h"
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":776
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":777
 * 
 * ctypedef npy_int8       int8_t
 * ctypedef npy_int16      int16_t             # <<<<<<<<<<<<<<
 * ctypedef npy_int32      int32_t
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":778
 * ctypedef npy_int8       int8_t
 * ctypedef npy_int16      int16_t
 * ctypedef npy_int32      int32_t             # <<<<<<<<<<<<<<
 * ctypedef npy_int64      int64_t
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":779
 * ctypedef npy_int16      int16_t
 * ctypedef npy_int32      int32_t
 * ctypedef npy_int64      int64_t             # <<<<<<<<<<<<<<
 * #ctypedef npy_int96      int96_t
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":783
 * #ctypedef npy_int128     int128_t
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":784
 * 
 * ctypedef npy_uint8      uint8_t
 * ctypedef npy_uint16     uint16_t             # <<<<<<<<<<<<<<
 * ctypedef npy_uint32     uint32_t
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":785
 * ctypedef npy_uint8      uint8_t
 * ctypedef npy_uint16     uint16_t
 * ctypedef npy_uint32     uint32_t             # <<<<<<<<<<<<<<
 * ctypedef npy_uint64     uint64_t
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":786
 * ctypedef npy_uint16     uint16_t
 * ctypedef npy_uint32     uint32_t
 * ctypedef npy_uint64     uint64_t             # <<<<<<<<<<<<<<
 * #ctypedef npy_uint96     uint96_t
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":790
 * #ctypedef npy_uint128    uint128_t
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":791
 * 
 * ctypedef npy_float32    float32_t
 * ctypedef npy_float64    float64_t             # <<<<<<<<<<<<<<
 * #ctypedef npy_float80    float80_t
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":800
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":801
 * # numpy.int corresponds to 'l' and numpy.long to 'q'
 * ctypedef npy_long       int_t
 * ctypedef npy_longlong   long_t             # <<<<<<<<<<<<<<
 * ctypedef npy_longlong   longlong_t
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":802
 * ctypedef npy_long       int_t
 * ctypedef npy_longlong   long_t
 * ctypedef npy_longlong   longlong_t             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":804
 * ctypedef npy_longlong   longlong_t
 * 
 * ctypedef npy_ulong      uint_t             # <<<<<<<<<<<<<<
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":805
 * 
 * ctypedef npy_ulong      uint_t
 * ctypedef npy_ulonglong  ulong_t             # <<<<<<<<<<<<<<
 * ctypedef npy_ulonglong  ulonglong_t
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":806
 * ctypedef npy_ulong      uint_t
 * ctypedef npy_ulonglong  ulong_t
 * ctypedef npy_ulonglong  ulonglong_t             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":808
 * ctypedef npy_ulonglong  ulonglong_t
 * 
 * ctypedef npy_intp       intp_t             # <<<<<<<<<<<<<<
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":809
 * 
 * ctypedef npy_intp       intp_t
 * ctypedef npy_uintp      uintp_t             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":811
 * ctypedef npy_uintp      uintp_t
 * 
 * ctypedef npy_double     float_t             # <<<<<<<<<<<<<<
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":812
 * 
 * ctypedef npy_double     float_t
 * ctypedef npy_double     double_t             # <<<<<<<<<<<<<<
 * ctypedef npy_longdouble longdouble_t
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":813
 * ctypedef npy_double     float_t
 * ctypedef npy_double     double_t
 * ctypedef npy_longdouble longdouble_t             # <<<<<<<<<<<<<<
 * 
...
struct __pyx_obj_7pygofmm_4core_PyRuntime;
struct __pyx_obj_7pygofmm_4core_PyConfig;
struct __pyx_obj_7pygofmm_4core_PyData;
struct __pyx_obj_7pygofmm_4core_PyDistData_CBLK;
struct __pyx_obj_7pygofmm_4core_PyDistData_RBLK;
struct __pyx_obj_7pygofmm_4core_PyDistData_RIDS;
struct __pyx_obj_7pygofmm_4core_PyDistPairData;
struct __pyx_obj_7pygofmm_4core_PyKernel;
struct __pyx_obj_7pygofmm_4core_PyDistKernelMatrix;
struct __pyx_obj_7pygofmm_4core_PyTreeKM;
struct __pyx_obj_7pygofmm_4core_KernelMatrix;
 ...
 * cdef class PyTreeKM:
 */
typedef hmlp::mpitree::Tree<hmlp::mpigofmm::Setup<hmlp::DistKernelMatrix<float,float> ,hmlp::mpigofmm::centersplit<hmlp::DistKernelMatrix<float,float> ,2,float> ,float> ,hmlp::gofmm::NodeData<float> >  __pyx_t_7pygofmm_4core_km_float_tree;

/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":815
 * ctypedef npy_longdouble longdouble_t
 * 
 * ctypedef npy_cfloat      cfloat_t             # <<<<<<<<<<<<<<
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":816
 * 
 * ctypedef npy_cfloat      cfloat_t
 * ctypedef npy_cdouble     cdouble_t             # <<<<<<<<<<<<<<
 * ctypedef npy_clongdouble clongdouble_t
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":817
 * ctypedef npy_cfloat      cfloat_t
 * ctypedef npy_cdouble     cdouble_t
 * ctypedef npy_clongdouble clongdouble_t             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":819
 * ctypedef npy_clongdouble clongdouble_t
 * 
 * ctypedef npy_cdouble     complex_t             # <<<<<<<<<<<<<<
 * 
...
struct __pyx_obj_7pygofmm_4core_PyConfig {
  PyObject_HEAD
  gofmm::Configuration<float>  *c_config;
  PyObject *metric_t;
};
...
struct __pyx_obj_7pygofmm_4core_PyData {
  PyObject_HEAD
  struct __pyx_vtabstruct_7pygofmm_4core_PyData *__pyx_vtab;
  hmlp::Data<float>  *c_data;
};
...
struct __pyx_obj_7pygofmm_4core_PyDistData_CBLK {
  PyObject_HEAD
  hmlp::STAR_CBLK_DistData<float>  *c_data;
  struct PyMPICommObject *our_comm;
};
...
struct __pyx_obj_7pygofmm_4core_PyDistData_RBLK {
  PyObject_HEAD
  hmlp::RBLK_STAR_DistData<float>  *c_data;
  struct PyMPICommObject *our_comm;
};
...
struct __pyx_obj_7pygofmm_4core_PyDistData_RIDS {
  PyObject_HEAD
  struct __pyx_vtabstruct_7pygofmm_4core_PyDistData_RIDS *__pyx_vtab;
  hmlp::RIDS_STAR_DistData<float>  *c_data;
  struct PyMPICommObject *our_comm;
...
struct __pyx_obj_7pygofmm_4core_PyDistPairData {
  PyObject_HEAD
  hmlp::STAR_CBLK_DistData<std::pair<float,size_t> >  *c_data;
};
...
struct __pyx_obj_7pygofmm_4core_PyKernel {
  PyObject_HEAD
  hmlp::kernel_s<float,float>  *c_kernel;
};
...
struct __pyx_obj_7pygofmm_4core_PyDistKernelMatrix {
  PyObject_HEAD
  hmlp::DistKernelMatrix<float,float>  *c_matrix;
};
...
struct __pyx_obj_7pygofmm_4core_PyTreeKM {
  PyObject_HEAD
  __pyx_t_7pygofmm_4core_km_float_tree *c_tree;
  struct PyMPICommObject *our_comm;
  int cStatus;
  int fStatus;
};
...
struct __pyx_obj_7pygofmm_4core_KernelMatrix {
  PyObject_HEAD
  struct __pyx_obj_7pygofmm_4core_PyKernel *kernel;
  struct __pyx_obj_7pygofmm_4core_PyTreeKM *tree;
  struct __pyx_obj_7pygofmm_4core_PyDistKernelMatrix *K;
  struct __pyx_obj_7pygofmm_4core_PyConfig *config;
  struct PyMPICommObject *comm_mpi;
  int is_compressed;
  int is_secacc;
  int is_factorized;
  int size;
...
struct __pyx_vtabstruct_7pygofmm_4core_PyData {
  PyObject *(*deepcopy)(struct __pyx_obj_7pygofmm_4core_PyData *, struct __pyx_obj_7pygofmm_4core_PyData *);
};
static struct __pyx_vtabstruct_7pygofmm_4core_PyData *__pyx_vtabptr_7pygofmm_4core_PyData;
...
struct __pyx_vtabstruct_7pygofmm_4core_PyDistData_RIDS {
  PyObject *(*columndata)(struct __pyx_obj_7pygofmm_4core_PyDistData_RIDS *, int);
};
static struct __pyx_vtabstruct_7pygofmm_4core_PyDistData_RIDS *__pyx_vtabptr_7pygofmm_4core_PyDistData_RIDS;
...
/* Module declarations from 'pygofmm.Runtime' */
...
/* Module declarations from 'pygofmm.Config' */
...
/* Module declarations from 'pygofmm.DistData' */

/* Module declarations from 'pygofmm.DistMatrix' */

/* Module declarations from 'pygofmm.DistTree' */

/* Module declarations from 'pygofmm.DistInverse' */
...
/* Module declarations from 'pygofmm.core' */
static PyTypeObject *__pyx_ptype_7pygofmm_4core_PyRuntime = 0;
static PyTypeObject *__pyx_ptype_7pygofmm_4core_PyConfig = 0;
static PyTypeObject *__pyx_ptype_7pygofmm_4core_PyData = 0;
static PyTypeObject *__pyx_ptype_7pygofmm_4core_PyDistData_CBLK = 0;
static PyTypeObject *__pyx_ptype_7pygofmm_4core_PyDistData_RBLK = 0;
static PyTypeObject *__pyx_ptype_7pygofmm_4core_PyDistData_RIDS = 0;
static PyTypeObject *__pyx_ptype_7pygofmm_4core_PyDistPairData = 0;
static PyTypeObject *__pyx_ptype_7pygofmm_4core_PyKernel = 0;
static PyTypeObject *__pyx_ptype_7pygofmm_4core_PyDistKernelMatrix = 0;
static PyTypeObject *__pyx_ptype_7pygofmm_4core_PyTreeKM = 0;
static PyTypeObject *__pyx_ptype_7pygofmm_4core_KernelMatrix = 0;
...
/* Module declarations from 'pygofmm.CustomKernel' */
...
/* Module declarations from 'pygofmm.mltools.algorithms' */
...
#define __Pyx_MODULE_NAME "pygofmm.mltools.algorithms"
extern int __pyx_module_is_main_pygofmm__mltools__algorithms;
int __pyx_module_is_main_pygofmm__mltools__algorithms = 0;

/* Implementation of 'pygofmm.mltools.algorithms' */
...
static const char __pyx_k_DKH[] = "DKH";
static const char __pyx_k_HDH[] = "HDH";
static const char __pyx_k_HKH[] = "HKH";
...
static const char __pyx_k_darr[] = "darr";
...
static const char __pyx_k_rids[] = "rids";
...
static const char __pyx_k_D_Data[] = "D_Data";
...
static const char __pyx_k_KH_Data[] = "KH_Data";
static const char __pyx_k_PyGOFMM[] = "PyGOFMM";
static const char __pyx_k_float32[] = "float32";
static const char __pyx_k_fortran[] = "fortran";
static const char __pyx_k_getComm[] = "getComm";
static const char __pyx_k_getGIDS[] = "getGIDS";
...
static const char __pyx_k_n_local[] = "n_local";
static const char __pyx_k_Ellipsis[] = "Ellipsis";
static const char __pyx_k_classvec[] = "classvec";
...
static const char __pyx_k_HDH_local[] = "HDH_local";
static const char __pyx_k_HKH_local[] = "HKH_local";
static const char __pyx_k_TypeError[] = "TypeError";
static const char __pyx_k_enumerate[] = "enumerate";
static const char __pyx_k_pyx_state[] = "__pyx_state";
static const char __pyx_k_reduce_ex[] = "__reduce_ex__";
static const char __pyx_k_testparam[] = "testparam";
static const char __pyx_k_IndexError[] = "IndexError";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_local_ones[] = "local_ones";
...
static const char __pyx_k_pygofmm_core[] = "pygofmm.core";
...
static const char __pyx_k_pygofmm_mltools_algorithms[] = "pygofmm.mltools.algorithms";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_pygofmm_mltools_algorithms_pyx[] = "pygofmm/mltools/algorithms.pyx";
...
static PyObject *__pyx_n_s_DKH;
static PyObject *__pyx_n_s_D_Data;
...
static PyObject *__pyx_n_s_HDH;
static PyObject *__pyx_n_s_HDH_local;
static PyObject *__pyx_n_s_HKH;
static PyObject *__pyx_n_s_HKH_local;
...
static PyObject *__pyx_n_s_KH_Data;
...
static PyObject *__pyx_n_s_PyGOFMM;
...
static PyObject *__pyx_n_s_classvec;
static PyObject *__pyx_n_s_cline_in_traceback;
static PyObject *__pyx_n_s_comm;
static PyObject *__pyx_kp_s_contiguous_and_direct;
static PyObject *__pyx_kp_s_contiguous_and_indirect;
static PyObject *__pyx_n_s_darr;
...
static PyObject *__pyx_n_s_getGIDS;
...
static PyObject *__pyx_n_s_k;
static PyObject *__pyx_n_s_local_ones;
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_maxiter;
static PyObject *__pyx_n_s_memview;
static PyObject *__pyx_n_s_mode;
static PyObject *__pyx_n_s_n_local;
...
static PyObject *__pyx_n_s_pygofmm_core;
static PyObject *__pyx_n_s_pygofmm_mltools_algorithms;
static PyObject *__pyx_kp_s_pygofmm_mltools_algorithms_pyx;
...
static PyObject *__pyx_n_s_rids;
...
static PyObject *__pyx_n_s_testparam;
...
static PyObject *__pyx_pf_7pygofmm_7mltools_10algorithms_testFunction(CYTHON_UNUSED PyObject *__pyx_self, struct __pyx_obj_7pygofmm_4core_PyRuntime *__pyx_v_testparam); /* proto */
static PyObject *__pyx_pf_7pygofmm_7mltools_10algorithms_2KMeans(CYTHON_UNUSED PyObject *__pyx_self, struct __pyx_obj_7pygofmm_4core_KernelMatrix *__pyx_v_K, int __pyx_v_nclasses, __Pyx_memviewslice __pyx_v_classvec, CYTHON_UNUSED PyObject *__pyx_v_maxiter); /* proto */
...
/* "pygofmm/mltools/algorithms.pyx":36
 * #REWRITE KKMEANS
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_7pygofmm_7mltools_10algorithms_1testFunction(PyObject *__pyx_self, PyObject *__pyx_v_testparam); /*proto*/
static PyMethodDef __pyx_mdef_7pygofmm_7mltools_10algorithms_1testFunction = {"testFunction", (PyCFunction)__pyx_pw_7pygofmm_7mltools_10algorithms_1testFunction, METH_O, 0};
static PyObject *__pyx_pw_7pygofmm_7mltools_10algorithms_1testFunction(PyObject *__pyx_self, PyObject *__pyx_v_testparam) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("testFunction (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_testparam), __pyx_ptype_7pygofmm_4core_PyRuntime, 1, "testparam", 0))) __PYX_ERR(0, 36, __pyx_L1_error)
  __pyx_r = __pyx_pf_7pygofmm_7mltools_10algorithms_testFunction(__pyx_self, ((struct __pyx_obj_7pygofmm_4core_PyRuntime *)__pyx_v_testparam));
...
static PyObject *__pyx_pf_7pygofmm_7mltools_10algorithms_testFunction(CYTHON_UNUSED PyObject *__pyx_self, struct __pyx_obj_7pygofmm_4core_PyRuntime *__pyx_v_testparam) {
  ...
  /* "pygofmm/mltools/algorithms.pyx":37
 * 
 * def testFunction(PyGOFMM.PyRuntime testparam):
 *     testparam.init()             # <<<<<<<<<<<<<<
 *     testparam.finalize()
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_testparam), __pyx_n_s_init); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
  ...
  /* "pygofmm/mltools/algorithms.pyx":38
 * def testFunction(PyGOFMM.PyRuntime testparam):
 *     testparam.init()
 *     testparam.finalize()             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_testparam), __pyx_n_s_finalize); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
    __pyx_t_3 = PyMethod_GET_SELF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_AddTraceback("pygofmm.mltools.algorithms.testFunction", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
/* "pygofmm/mltools/algorithms.pyx":44
...
/* Python wrapper */
static PyObject *__pyx_pw_7pygofmm_7mltools_10algorithms_3KMeans(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_7pygofmm_7mltools_10algorithms_3KMeans = {"KMeans", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7pygofmm_7mltools_10algorithms_3KMeans, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_7pygofmm_7mltools_10algorithms_3KMeans(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  struct __pyx_obj_7pygofmm_4core_KernelMatrix *__pyx_v_K = 0;
  int __pyx_v_nclasses;
  __Pyx_memviewslice __pyx_v_classvec = { 0, 0, { 0 }, { 0 }, { 0 } };
  CYTHON_UNUSED PyObject *__pyx_v_maxiter = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("KMeans (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_K,&__pyx_n_s_nclasses,&__pyx_n_s_classvec,&__pyx_n_s_maxiter,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nclasses)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("KMeans", 0, 2, 4, 1); __PYX_ERR(0, 44, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
          PyObject* value = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_classvec);
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "KMeans") < 0)) __PYX_ERR(0, 44, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_K = ((struct __pyx_obj_7pygofmm_4core_KernelMatrix *)values[0]);
    __pyx_v_nclasses = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_nclasses == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L3_error)
    if (values[2]) {
      __pyx_v_classvec = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_classvec.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    } else {
      __pyx_v_classvec = __pyx_k_;
      __PYX_INC_MEMVIEW(&__pyx_v_classvec, 1);
    }
    __pyx_v_maxiter = values[3];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("KMeans", 0, 2, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 44, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pygofmm.mltools.algorithms.KMeans", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_K), __pyx_ptype_7pygofmm_4core_KernelMatrix, 1, "K", 0))) __PYX_ERR(0, 44, __pyx_L1_error)
  __pyx_r = __pyx_pf_7pygofmm_7mltools_10algorithms_2KMeans(__pyx_self, __pyx_v_K, __pyx_v_nclasses, __pyx_v_classvec, __pyx_v_maxiter);
...
static PyObject *__pyx_pf_7pygofmm_7mltools_10algorithms_2KMeans(CYTHON_UNUSED PyObject *__pyx_self, struct __pyx_obj_7pygofmm_4core_KernelMatrix *__pyx_v_K, int __pyx_v_nclasses, __Pyx_memviewslice __pyx_v_classvec, CYTHON_UNUSED PyObject *__pyx_v_maxiter) {
  int __pyx_v_N;
  int __pyx_v_n_local;
  int __pyx_v_c;
  int __pyx_v_i;
  struct PyMPICommObject *__pyx_v_comm = 0;
  __Pyx_memviewslice __pyx_v_cI = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_rids = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_local_ones = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_v_Ones = NULL;
  PyObject *__pyx_v_D = NULL;
  CYTHON_UNUSED PyObject *__pyx_v_H = NULL;
  CYTHON_UNUSED __Pyx_memviewslice __pyx_v_HKH_local = { 0, 0, { 0 }, { 0 }, { 0 } };
  CYTHON_UNUSED __Pyx_memviewslice __pyx_v_HKH = { 0, 0, { 0 }, { 0 }, { 0 } };
  CYTHON_UNUSED __Pyx_memviewslice __pyx_v_HDH_local = { 0, 0, { 0 }, { 0 }, { 0 } };
  CYTHON_UNUSED __Pyx_memviewslice __pyx_v_HDH = { 0, 0, { 0 }, { 0 }, { 0 } };
  CYTHON_UNUSED __Pyx_memviewslice __pyx_v_DKH = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  /* "pygofmm/mltools/algorithms.pyx":46
 * def KMeans(PyGOFMM.KernelMatrix K,int nclasses, int[:] classvec=None, maxiter=10):
 *     cdef int N, n_local, c, i, j, k
 *     N = K.getSize()             # <<<<<<<<<<<<<<
 *     cdef MPI.Comm comm
 *     comm = K.getComm()
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_K), __pyx_n_s_getSize); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 46, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
    __pyx_t_3 = PyMethod_GET_SELF(__pyx_t_2);
  ...
  /* "pygofmm/mltools/algorithms.pyx":48
 *     N = K.getSize()
 *     cdef MPI.Comm comm
 *     comm = K.getComm()             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_K), __pyx_n_s_getComm); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
    __pyx_t_3 = PyMethod_GET_SELF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (!(likely(((__pyx_t_1) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_1, __pyx_ptype_6mpi4py_3MPI_Comm))))) __PYX_ERR(0, 48, __pyx_L1_error)
  __pyx_v_comm = ((struct PyMPICommObject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "pygofmm/mltools/algorithms.pyx":49
 *     cdef MPI.Comm comm
 *     comm = K.getComm()
 *     cdef float[:, :] cI = np.zeros([N, nclasses], dtype='float32', order='F')             # <<<<<<<<<<<<<<
 *     cdef int[:] rids = K.getTree().getGIDS() #TODO: Add GIDS function to K
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_nclasses); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 49, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_n_s_float32) < 0) __PYX_ERR(0, 49, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_order, __pyx_n_s_F) < 0) __PYX_ERR(0, 49, __pyx_L1_error)
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_cI = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pygofmm/mltools/algorithms.pyx":50
 *     comm = K.getComm()
 *     cdef float[:, :] cI = np.zeros([N, nclasses], dtype='float32', order='F')
 *     cdef int[:] rids = K.getTree().getGIDS() #TODO: Add GIDS function to K             # <<<<<<<<<<<<<<
 *     n_local = len(rids)
 *     if classvec is None:
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_K), __pyx_n_s_getTree); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = NULL;
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_getGIDS); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_3))) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_rids = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "pygofmm/mltools/algorithms.pyx":51
 *     cdef float[:, :] cI = np.zeros([N, nclasses], dtype='float32', order='F')
 *     cdef int[:] rids = K.getTree().getGIDS() #TODO: Add GIDS function to K
 *     n_local = len(rids)             # <<<<<<<<<<<<<<
 *     if classvec is None:
 ...
 */
  __pyx_t_8 = __Pyx_MemoryView_Len(__pyx_v_rids); 
  __pyx_v_n_local = __pyx_t_8;

  /* "pygofmm/mltools/algorithms.pyx":52
 *     cdef int[:] rids = K.getTree().getGIDS() #TODO: Add GIDS function to K
 *     n_local = len(rids)
 *     if classvec is None:             # <<<<<<<<<<<<<<
 *         #initialize class indicator block
 ...
 */
  __pyx_t_9 = ((((PyObject *) __pyx_v_classvec.memview) == Py_None) != 0);
  if (__pyx_t_9) {

    /* "pygofmm/mltools/algorithms.pyx":54
 *     if classvec is None:
 *         #initialize class indicator block
 *         for i in prange(N, nogil=True):             # <<<<<<<<<<<<<<
 ...
 */
    {
        ...
        /*try:*/ {
          ...
          if (1 == 0) abort();
          {
              ...
              {
                  #ifdef _OPENMP
                  #pragma omp parallel private(__pyx_t_12, __pyx_t_13, __pyx_t_14) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                  #endif /* _OPENMP */
                  {
                      #ifdef _OPENMP
                      #ifdef WITH_THREAD
                      ...
                      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_11; __pyx_t_10++){
                          if (__pyx_parallel_why < 2)
                          {
                              ...
                              /* "pygofmm/mltools/algorithms.pyx":56
 *         for i in prange(N, nogil=True):
 *             #Assign random class to each element
 *             c = 1 + <int>(rand()/RAND_MAX*nclasses)             # <<<<<<<<<<<<<<
 *             cI[i, c] = 1.0
 ...
 */
                              ...
                              else if (sizeof(int) == sizeof(long) && (!(((int)-1) > 0)) && unlikely(RAND_MAX == (int)-1)  && unlikely(UNARY_NEG_WOULD_OVERFLOW(__pyx_t_12))) {
                                #ifdef WITH_THREAD
                                PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                                #endif
                              ...
                              __pyx_v_c = (1 + ((int)(__Pyx_div_int(__pyx_t_12, RAND_MAX) * __pyx_v_nclasses)));

                              /* "pygofmm/mltools/algorithms.pyx":57
 *             #Assign random class to each element
 *             c = 1 + <int>(rand()/RAND_MAX*nclasses)
 *             cI[i, c] = 1.0             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
                              ...
                              __pyx_t_12 = -1;
                              if (__pyx_t_13 < 0) {
                                __pyx_t_13 += __pyx_v_cI.shape[0];
                                if (unlikely(__pyx_t_13 < 0)) __pyx_t_12 = 0;
                              } else if (unlikely(__pyx_t_13 >= __pyx_v_cI.shape[0])) __pyx_t_12 = 0;
                              if (__pyx_t_14 < 0) {
                                __pyx_t_14 += __pyx_v_cI.shape[1];
                                if (unlikely(__pyx_t_14 < 0)) __pyx_t_12 = 1;
                              } else if (unlikely(__pyx_t_14 >= __pyx_v_cI.shape[1])) __pyx_t_12 = 1;
                              if (unlikely(__pyx_t_12 != -1)) {
                                __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_12);
                                __PYX_ERR(0, 57, __pyx_L9_error)
                              }
                              *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_cI.data + __pyx_t_13 * __pyx_v_cI.strides[0]) ) + __pyx_t_14 * __pyx_v_cI.strides[1]) )) = 1.0;
                              goto __pyx_L12;
                              __pyx_L9_error:;
                              {
                                  #ifdef WITH_THREAD
 ...
 */
  ...
  /* "pygofmm/mltools/algorithms.pyx":59
 *             cI[i, c] = 1.0
 *     else:
 *         for i in prange(N, nogil=True):             # <<<<<<<<<<<<<<
 *             c = classvec[i]
  ...
  /*else*/ {
    {
        ...
        /*try:*/ {
          ...
          if (1 == 0) abort();
          {
              ...
              {
                  #ifdef _OPENMP
                  #pragma omp parallel private(__pyx_t_12, __pyx_t_15, __pyx_t_16, __pyx_t_17) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                  #endif /* _OPENMP */
                  {
                      #ifdef _OPENMP
                      #ifdef WITH_THREAD
                      ...
                      #pragma omp for lastprivate(__pyx_v_c) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i)
                      #endif /* _OPENMP */
                      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_4; __pyx_t_10++){
                          if (__pyx_parallel_why < 2)
                          {
                              __pyx_v_i = (int)(0 + 1 * __pyx_t_10);
                              /* Initialize private variables to invalid values */
                              ...
                              /* "pygofmm/mltools/algorithms.pyx":60
 *     else:
 *         for i in prange(N, nogil=True):
 *             c = classvec[i]             # <<<<<<<<<<<<<<
 *             cI[i, c] = 1.0
 ...
 */
                              ...
                              __pyx_t_12 = -1;
                              if (__pyx_t_15 < 0) {
                                __pyx_t_15 += __pyx_v_classvec.shape[0];
                                if (unlikely(__pyx_t_15 < 0)) __pyx_t_12 = 0;
                              } else if (unlikely(__pyx_t_15 >= __pyx_v_classvec.shape[0])) __pyx_t_12 = 0;
                              if (unlikely(__pyx_t_12 != -1)) {
                                __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_12);
                                __PYX_ERR(0, 60, __pyx_L18_error)
                              }
                              __pyx_v_c = (*((int *) ( /* dim=0 */ (__pyx_v_classvec.data + __pyx_t_15 * __pyx_v_classvec.strides[0]) )));

                              /* "pygofmm/mltools/algorithms.pyx":61
 *         for i in prange(N, nogil=True):
 *             c = classvec[i]
 *             cI[i, c] = 1.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
                              ...
                              __pyx_t_12 = -1;
                              if (__pyx_t_16 < 0) {
                                __pyx_t_16 += __pyx_v_cI.shape[0];
                                if (unlikely(__pyx_t_16 < 0)) __pyx_t_12 = 0;
                              } else if (unlikely(__pyx_t_16 >= __pyx_v_cI.shape[0])) __pyx_t_12 = 0;
                              if (__pyx_t_17 < 0) {
                                __pyx_t_17 += __pyx_v_cI.shape[1];
                                if (unlikely(__pyx_t_17 < 0)) __pyx_t_12 = 1;
                              } else if (unlikely(__pyx_t_17 >= __pyx_v_cI.shape[1])) __pyx_t_12 = 1;
                              if (unlikely(__pyx_t_12 != -1)) {
                                __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_12);
                                __PYX_ERR(0, 61, __pyx_L18_error)
                              }
                              *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_cI.data + __pyx_t_16 * __pyx_v_cI.strides[0]) ) + __pyx_t_17 * __pyx_v_cI.strides[1]) )) = 1.0;
                              goto __pyx_L21;
                              __pyx_L18_error:;
                              {
                                  #ifdef WITH_THREAD
 ...
 */
  ...
  /* "pygofmm/mltools/algorithms.pyx":64
 * 
 *     #copy class indicator block to DistData object
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_ones); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_n_local); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_n_s_float32) < 0) __PYX_ERR(0, 64, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_order, __pyx_n_s_F) < 0) __PYX_ERR(0, 64, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_1, __pyx_t_5); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_local_ones = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pygofmm/mltools/algorithms.pyx":65
 *     #copy class indicator block to DistData object
 *     cdef float[:, :] local_ones = np.ones([n_local, 1], dtype='float32', order='F')
 *     Ones = PyGOFMM.PyDistData_RIDS(comm, N, 1, iset=rids, darr=local_ones)             # <<<<<<<<<<<<<<
 *     D = K.evaluate(Ones)
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_5, 0, ((PyObject *)__pyx_v_comm));
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_rids, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_iset, __pyx_t_1) < 0) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_local_ones, 2, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_darr, __pyx_t_1) < 0) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7pygofmm_4core_PyDistData_RIDS), __pyx_t_5, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "pygofmm/mltools/algorithms.pyx":66
 *     cdef float[:, :] local_ones = np.ones([n_local, 1], dtype='float32', order='F')
 *     Ones = PyGOFMM.PyDistData_RIDS(comm, N, 1, iset=rids, darr=local_ones)
 *     D = K.evaluate(Ones)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_K), __pyx_n_s_evaluate); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_5 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
  ...
  __pyx_t_1 = (__pyx_t_5) ? __Pyx_PyObject_Call2Args(__pyx_t_2, __pyx_t_5, __pyx_v_Ones) : __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_v_Ones);
  __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  /* "pygofmm/mltools/algorithms.pyx":68
 *     D = K.evaluate(Ones)
 * 
 *     H = PyGOFMM.PyDistData_RIDS(comm, N, nclasses, iset=rids, darr=cI)             # <<<<<<<<<<<<<<
 *     #Main Loop
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_nclasses); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_rids, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_iset, __pyx_t_1) < 0) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_cI, 2, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_darr, __pyx_t_1) < 0) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7pygofmm_4core_PyDistData_RIDS), __pyx_t_5, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_H = __pyx_t_1;
  ...
  /* "pygofmm/mltools/algorithms.pyx":70
 *     H = PyGOFMM.PyDistData_RIDS(comm, N, nclasses, iset=rids, darr=cI)
 *     #Main Loop
 *     cdef float[:, :] HKH_local = np.zeros([nclasses, nclasses], dtype='float32', order='F')             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_nclasses); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_nclasses); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_n_s_float32) < 0) __PYX_ERR(0, 70, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_order, __pyx_n_s_F) < 0) __PYX_ERR(0, 70, __pyx_L1_error)
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_HKH_local = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pygofmm/mltools/algorithms.pyx":71
 *     #Main Loop
 *     cdef float[:, :] HKH_local = np.zeros([nclasses, nclasses], dtype='float32', order='F')
 *     cdef float[:, :] HKH = np.zeros([nclasses, nclasses], dtype='float32', order='F')             # <<<<<<<<<<<<<<
 *     cdef float[:, :] HDH_local = np.zeros([nclasses, nclasses], dtype='float32', order='F')
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_zeros); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_nclasses); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_nclasses); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_n_s_float32) < 0) __PYX_ERR(0, 71, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_order, __pyx_n_s_F) < 0) __PYX_ERR(0, 71, __pyx_L1_error)
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_5, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_HKH = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pygofmm/mltools/algorithms.pyx":72
 *     cdef float[:, :] HKH_local = np.zeros([nclasses, nclasses], dtype='float32', order='F')
 *     cdef float[:, :] HKH = np.zeros([nclasses, nclasses], dtype='float32', order='F')
 *     cdef float[:, :] HDH_local = np.zeros([nclasses, nclasses], dtype='float32', order='F')             # <<<<<<<<<<<<<<
 *     cdef float[:, :] HDH = np.zeros([nclasses, nclasses], dtype='float32', order='F')
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_nclasses); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_nclasses); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_n_s_float32) < 0) __PYX_ERR(0, 72, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_order, __pyx_n_s_F) < 0) __PYX_ERR(0, 72, __pyx_L1_error)
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_HDH_local = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pygofmm/mltools/algorithms.pyx":73
 *     cdef float[:, :] HKH = np.zeros([nclasses, nclasses], dtype='float32', order='F')
 *     cdef float[:, :] HDH_local = np.zeros([nclasses, nclasses], dtype='float32', order='F')
 *     cdef float[:, :] HDH = np.zeros([nclasses, nclasses], dtype='float32', order='F')             # <<<<<<<<<<<<<<
 *     cdef float[:, :] DKH = np.zeros([n_local, nclasses], dtype='float32', order='F')
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_nclasses); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_nclasses); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_n_s_float32) < 0) __PYX_ERR(0, 73, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_order, __pyx_n_s_F) < 0) __PYX_ERR(0, 73, __pyx_L1_error)
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_5, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_HDH = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pygofmm/mltools/algorithms.pyx":74
 *     cdef float[:, :] HDH_local = np.zeros([nclasses, nclasses], dtype='float32', order='F')
 *     cdef float[:, :] HDH = np.zeros([nclasses, nclasses], dtype='float32', order='F')
 *     cdef float[:, :] DKH = np.zeros([n_local, nclasses], dtype='float32', order='F')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_n_local); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 74, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_nclasses); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 74, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_order, __pyx_n_s_F) < 0) __PYX_ERR(0, 74, __pyx_L1_error)
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 74, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 74, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_DKH = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pygofmm/mltools/algorithms.pyx":79
 *     cdef float* D_Data
 *     cdef float* KH_Data
 *     print(type(D.c_data))             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_D, __pyx_n_s_c_data); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_PrintOne(0, ((PyObject *)Py_TYPE(__pyx_t_1))) < 0) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_cI, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_rids, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_local_ones, 1);
  __Pyx_XDECREF(__pyx_v_Ones);
  __Pyx_XDECREF(__pyx_v_D);
  __Pyx_XDECREF(__pyx_v_H);
  __PYX_XDEC_MEMVIEW(&__pyx_v_HKH_local, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_HKH, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_HDH_local, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_HDH, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_DKH, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_classvec, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "pygofmm/mltools/algorithms.pyx":117
...
static PyObject *__pyx_f_7pygofmm_7mltools_10algorithms_KKMeansHelper(CYTHON_UNUSED hmlp::RIDS_STAR_DistData<float>  __pyx_v_H) {
  CYTHON_UNUSED long __pyx_v_a;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("KKMeansHelper", 0);

  /* "pygofmm/mltools/algorithms.pyx":118
 * @cython.nonecheck(False)
 * cdef KKMeansHelper(RIDS_STAR_DistData[float] H, ):
 *     a = 10             # <<<<<<<<<<<<<<
 */
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":258
...
static int __pyx_pf_5numpy_7ndarray___getbuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":265
 * 
 *             cdef int i, ndim
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":266
 *             cdef int i, ndim
 *             cdef int endian_detector = 1
 *             cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":268
 *             cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)
 * 
 *             ndim = PyArray_NDIM(self)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":270
 *             ndim = PyArray_NDIM(self)
 * 
 *             if ((flags & pybuf.PyBUF_C_CONTIGUOUS == pybuf.PyBUF_C_CONTIGUOUS)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":271
 * 
 *             if ((flags & pybuf.PyBUF_C_CONTIGUOUS == pybuf.PyBUF_C_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_ARRAY_C_CONTIGUOUS)):             # <<<<<<<<<<<<<<
 *                 raise ValueError(u"ndarray is not C contiguous")
 ...
 */
  if (unlikely(__pyx_t_1)) {
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":272
 *             if ((flags & pybuf.PyBUF_C_CONTIGUOUS == pybuf.PyBUF_C_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_ARRAY_C_CONTIGUOUS)):
 *                 raise ValueError(u"ndarray is not C contiguous")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":274
 *                 raise ValueError(u"ndarray is not C contiguous")
 * 
 *             if ((flags & pybuf.PyBUF_F_CONTIGUOUS == pybuf.PyBUF_F_CONTIGUOUS)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":275
 * 
 *             if ((flags & pybuf.PyBUF_F_CONTIGUOUS == pybuf.PyBUF_F_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_ARRAY_F_CONTIGUOUS)):             # <<<<<<<<<<<<<<
 *                 raise ValueError(u"ndarray is not Fortran contiguous")
 ...
 */
  if (unlikely(__pyx_t_1)) {
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":276
 *             if ((flags & pybuf.PyBUF_F_CONTIGUOUS == pybuf.PyBUF_F_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_ARRAY_F_CONTIGUOUS)):
 *                 raise ValueError(u"ndarray is not Fortran contiguous")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":278
 *                 raise ValueError(u"ndarray is not Fortran contiguous")
 * 
 *             info.buf = PyArray_DATA(self)             # <<<<<<<<<<<<<<
 *             info.ndim = ndim
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":279
 * 
 *             info.buf = PyArray_DATA(self)
 *             info.ndim = ndim             # <<<<<<<<<<<<<<
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":280
 *             info.buf = PyArray_DATA(self)
 *             info.ndim = ndim
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):             # <<<<<<<<<<<<<<
 *                 # Allocate new buffer for strides and shape info.
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":283
 *                 # Allocate new buffer for strides and shape info.
 *                 # This is allocated as one block, strides first.
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":284
 *                 # This is allocated as one block, strides first.
 *                 info.strides = <Py_ssize_t*>PyObject_Malloc(sizeof(Py_ssize_t) * 2 * <size_t>ndim)
 *                 info.shape = info.strides + ndim             # <<<<<<<<<<<<<<
 *                 for i in range(ndim):
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":285
 *                 info.strides = <Py_ssize_t*>PyObject_Malloc(sizeof(Py_ssize_t) * 2 * <size_t>ndim)
 *                 info.shape = info.strides + ndim
 *                 for i in range(ndim):             # <<<<<<<<<<<<<<
 *                     info.strides[i] = PyArray_STRIDES(self)[i]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":286
 *                 info.shape = info.strides + ndim
 *                 for i in range(ndim):
 *                     info.strides[i] = PyArray_STRIDES(self)[i]             # <<<<<<<<<<<<<<
 *                     info.shape[i] = PyArray_DIMS(self)[i]
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":287
 *                 for i in range(ndim):
 *                     info.strides[i] = PyArray_STRIDES(self)[i]
 *                     info.shape[i] = PyArray_DIMS(self)[i]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":289
 *                     info.shape[i] = PyArray_DIMS(self)[i]
 *             else:
 *                 info.strides = <Py_ssize_t*>PyArray_STRIDES(self)             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":290
 *             else:
 *                 info.strides = <Py_ssize_t*>PyArray_STRIDES(self)
 *                 info.shape = <Py_ssize_t*>PyArray_DIMS(self)             # <<<<<<<<<<<<<<
 *             info.suboffsets = NULL
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":291
 *                 info.strides = <Py_ssize_t*>PyArray_STRIDES(self)
 *                 info.shape = <Py_ssize_t*>PyArray_DIMS(self)
 *             info.suboffsets = NULL             # <<<<<<<<<<<<<<
 *             info.itemsize = PyArray_ITEMSIZE(self)
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":292
 *                 info.shape = <Py_ssize_t*>PyArray_DIMS(self)
 *             info.suboffsets = NULL
 *             info.itemsize = PyArray_ITEMSIZE(self)             # <<<<<<<<<<<<<<
 *             info.readonly = not PyArray_ISWRITEABLE(self)
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":293
 *             info.suboffsets = NULL
 *             info.itemsize = PyArray_ITEMSIZE(self)
 *             info.readonly = not PyArray_ISWRITEABLE(self)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":296
 * 
 *             cdef int t
 *             cdef char* f = NULL             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":297
 *             cdef int t
 *             cdef char* f = NULL
 *             cdef dtype descr = <dtype>PyArray_DESCR(self)             # <<<<<<<<<<<<<<
 *             cdef int offset
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":300
 *             cdef int offset
 * 
 *             info.obj = self             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":302
 *             info.obj = self
 * 
 *             if not PyDataType_HASFIELDS(descr):             # <<<<<<<<<<<<<<
 *                 t = descr.type_num
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":303
 * 
 *             if not PyDataType_HASFIELDS(descr):
 *                 t = descr.type_num             # <<<<<<<<<<<<<<
 *                 if ((descr.byteorder == c'>' and little_endian) or
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":304
 *             if not PyDataType_HASFIELDS(descr):
 *                 t = descr.type_num
 *                 if ((descr.byteorder == c'>' and little_endian) or             # <<<<<<<<<<<<<<
 *                     (descr.byteorder == c'<' and not little_endian)):
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":305
 *                 t = descr.type_num
 *                 if ((descr.byteorder == c'>' and little_endian) or
 *                     (descr.byteorder == c'<' and not little_endian)):             # <<<<<<<<<<<<<<
 *                     raise ValueError(u"Non-native byte order not supported")
 ...
 */
    if (unlikely(__pyx_t_1)) {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":306
 *                 if ((descr.byteorder == c'>' and little_endian) or
 *                     (descr.byteorder == c'<' and not little_endian)):
 *                     raise ValueError(u"Non-native byte order not supported")             # <<<<<<<<<<<<<<
 *                 if   t == NPY_BYTE:        f = "b"
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":307
 *                     (descr.byteorder == c'<' and not little_endian)):
 *                     raise ValueError(u"Non-native byte order not supported")
 *                 if   t == NPY_BYTE:        f = "b"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_UBYTE:       f = "B"
 ...
 */
    switch (__pyx_v_t) {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":308
 *                     raise ValueError(u"Non-native byte order not supported")
 *                 if   t == NPY_BYTE:        f = "b"
 *                 elif t == NPY_UBYTE:       f = "B"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_SHORT:       f = "h"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":309
 *                 if   t == NPY_BYTE:        f = "b"
 *                 elif t == NPY_UBYTE:       f = "B"
 *                 elif t == NPY_SHORT:       f = "h"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_USHORT:      f = "H"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":310
 *                 elif t == NPY_UBYTE:       f = "B"
 *                 elif t == NPY_SHORT:       f = "h"
 *                 elif t == NPY_USHORT:      f = "H"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_INT:         f = "i"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":311
 *                 elif t == NPY_SHORT:       f = "h"
 *                 elif t == NPY_USHORT:      f = "H"
 *                 elif t == NPY_INT:         f = "i"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_UINT:        f = "I"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":312
 *                 elif t == NPY_USHORT:      f = "H"
 *                 elif t == NPY_INT:         f = "i"
 *                 elif t == NPY_UINT:        f = "I"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_LONG:        f = "l"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":313
 *                 elif t == NPY_INT:         f = "i"
 *                 elif t == NPY_UINT:        f = "I"
 *                 elif t == NPY_LONG:        f = "l"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_ULONG:       f = "L"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":314
 *                 elif t == NPY_UINT:        f = "I"
 *                 elif t == NPY_LONG:        f = "l"
 *                 elif t == NPY_ULONG:       f = "L"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_LONGLONG:    f = "q"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":315
 *                 elif t == NPY_LONG:        f = "l"
 *                 elif t == NPY_ULONG:       f = "L"
 *                 elif t == NPY_LONGLONG:    f = "q"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_ULONGLONG:   f = "Q"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":316
 *                 elif t == NPY_ULONG:       f = "L"
 *                 elif t == NPY_LONGLONG:    f = "q"
 *                 elif t == NPY_ULONGLONG:   f = "Q"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_FLOAT:       f = "f"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":317
 *                 elif t == NPY_LONGLONG:    f = "q"
 *                 elif t == NPY_ULONGLONG:   f = "Q"
 *                 elif t == NPY_FLOAT:       f = "f"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_DOUBLE:      f = "d"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":318
 *                 elif t == NPY_ULONGLONG:   f = "Q"
 *                 elif t == NPY_FLOAT:       f = "f"
 *                 elif t == NPY_DOUBLE:      f = "d"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_LONGDOUBLE:  f = "g"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":319
 *                 elif t == NPY_FLOAT:       f = "f"
 *                 elif t == NPY_DOUBLE:      f = "d"
 *                 elif t == NPY_LONGDOUBLE:  f = "g"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_CFLOAT:      f = "Zf"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":320
 *                 elif t == NPY_DOUBLE:      f = "d"
 *                 elif t == NPY_LONGDOUBLE:  f = "g"
 *                 elif t == NPY_CFLOAT:      f = "Zf"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_CDOUBLE:     f = "Zd"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":321
 *                 elif t == NPY_LONGDOUBLE:  f = "g"
 *                 elif t == NPY_CFLOAT:      f = "Zf"
 *                 elif t == NPY_CDOUBLE:     f = "Zd"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_CLONGDOUBLE: f = "Zg"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":322
 *                 elif t == NPY_CFLOAT:      f = "Zf"
 *                 elif t == NPY_CDOUBLE:     f = "Zd"
 *                 elif t == NPY_CLONGDOUBLE: f = "Zg"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_OBJECT:      f = "O"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":323
 *                 elif t == NPY_CDOUBLE:     f = "Zd"
 *                 elif t == NPY_CLONGDOUBLE: f = "Zg"
 *                 elif t == NPY_OBJECT:      f = "O"             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":325
 *                 elif t == NPY_OBJECT:      f = "O"
 *                 else:
 *                     raise ValueError(u"unknown dtype code in numpy.pxd (%d)" % t)             # <<<<<<<<<<<<<<
 *                 info.format = f
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":326
 *                 else:
 *                     raise ValueError(u"unknown dtype code in numpy.pxd (%d)" % t)
 *                 info.format = f             # <<<<<<<<<<<<<<
 *                 return
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":327
 *                     raise ValueError(u"unknown dtype code in numpy.pxd (%d)" % t)
 *                 info.format = f
 *                 return             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":329
 *                 return
 *             else:
 *                 info.format = <char*>PyObject_Malloc(_buffer_format_string_len)             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":330
 *             else:
 *                 info.format = <char*>PyObject_Malloc(_buffer_format_string_len)
 *                 info.format[0] = c'^' # Native data types, manual alignment             # <<<<<<<<<<<<<<
 *                 offset = 0
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":331
 *                 info.format = <char*>PyObject_Malloc(_buffer_format_string_len)
 *                 info.format[0] = c'^' # Native data types, manual alignment
 *                 offset = 0             # <<<<<<<<<<<<<<
 *                 f = _util_dtypestring(descr, info.format + 1,
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":332
 *                 info.format[0] = c'^' # Native data types, manual alignment
 *                 offset = 0
 *                 f = _util_dtypestring(descr, info.format + 1,             # <<<<<<<<<<<<<<
 *                                       info.format + _buffer_format_string_len,
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":335
 *                                       info.format + _buffer_format_string_len,
 *                                       &offset)
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":337
 *                 f[0] = c'\0' # Terminate format string
 * 
 *         def __releasebuffer__(ndarray self, Py_buffer* info):             # <<<<<<<<<<<<<<
...
static void __pyx_pf_5numpy_7ndarray_2__releasebuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":338
 * 
 *         def __releasebuffer__(ndarray self, Py_buffer* info):
 *             if PyArray_HASFIELDS(self):             # <<<<<<<<<<<<<<
 *                 PyObject_Free(info.format)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":339
 *         def __releasebuffer__(ndarray self, Py_buffer* info):
 *             if PyArray_HASFIELDS(self):
 *                 PyObject_Free(info.format)             # <<<<<<<<<<<<<<
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":340
 *             if PyArray_HASFIELDS(self):
 *                 PyObject_Free(info.format)
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):             # <<<<<<<<<<<<<<
 *                 PyObject_Free(info.strides)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":341
 *                 PyObject_Free(info.format)
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):
 *                 PyObject_Free(info.strides)             # <<<<<<<<<<<<<<
 *                 # info.shape was stored after info.strides in the same block
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":821
 * ctypedef npy_cdouble     complex_t
 * 
 * cdef inline object PyArray_MultiIterNew1(a):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyArray_MultiIterNew1(PyObject *__pyx_v_a) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":822
 * 
 * cdef inline object PyArray_MultiIterNew1(a):
 *     return PyArray_MultiIterNew(1, <void*>a)             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":824
 *     return PyArray_MultiIterNew(1, <void*>a)
 * 
 * cdef inline object PyArray_MultiIterNew2(a, b):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyArray_MultiIterNew2(PyObject *__pyx_v_a, PyObject *__pyx_v_b) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":825
 * 
 * cdef inline object PyArray_MultiIterNew2(a, b):
 *     return PyArray_MultiIterNew(2, <void*>a, <void*>b)             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":827
 *     return PyArray_MultiIterNew(2, <void*>a, <void*>b)
 * 
 * cdef inline object PyArray_MultiIterNew3(a, b, c):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyArray_MultiIterNew3(PyObject *__pyx_v_a, PyObject *__pyx_v_b, PyObject *__pyx_v_c) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":828
 * 
 * cdef inline object PyArray_MultiIterNew3(a, b, c):
 *     return PyArray_MultiIterNew(3, <void*>a, <void*>b, <void*> c)             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":830
 *     return PyArray_MultiIterNew(3, <void*>a, <void*>b, <void*> c)
 * 
 * cdef inline object PyArray_MultiIterNew4(a, b, c, d):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyArray_MultiIterNew4(PyObject *__pyx_v_a, PyObject *__pyx_v_b, PyObject *__pyx_v_c, PyObject *__pyx_v_d) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":831
 * 
 * cdef inline object PyArray_MultiIterNew4(a, b, c, d):
 *     return PyArray_MultiIterNew(4, <void*>a, <void*>b, <void*>c, <void*> d)             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":833
 *     return PyArray_MultiIterNew(4, <void*>a, <void*>b, <void*>c, <void*> d)
 * 
 * cdef inline object PyArray_MultiIterNew5(a, b, c, d, e):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyArray_MultiIterNew5(PyObject *__pyx_v_a, PyObject *__pyx_v_b, PyObject *__pyx_v_c, PyObject *__pyx_v_d, PyObject *__pyx_v_e) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":834
 * 
 * cdef inline object PyArray_MultiIterNew5(a, b, c, d, e):
 *     return PyArray_MultiIterNew(5, <void*>a, <void*>b, <void*>c, <void*> d, <void*> e)             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":836
 *     return PyArray_MultiIterNew(5, <void*>a, <void*>b, <void*>c, <void*> d, <void*> e)
 * 
 * cdef inline tuple PyDataType_SHAPE(dtype d):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyDataType_SHAPE(PyArray_Descr *__pyx_v_d) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":837
 * 
 * cdef inline tuple PyDataType_SHAPE(dtype d):
 *     if PyDataType_HASSUBARRAY(d):             # <<<<<<<<<<<<<<
 *         return <tuple>d.subarray.shape
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":838
 * cdef inline tuple PyDataType_SHAPE(dtype d):
 *     if PyDataType_HASSUBARRAY(d):
 *         return <tuple>d.subarray.shape             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":840
 *         return <tuple>d.subarray.shape
 *     else:
 *         return ()             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":842
 *         return ()
 * 
 * cdef inline char* _util_dtypestring(dtype descr, char* f, char* end, int* offset) except NULL:             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE char *__pyx_f_5numpy__util_dtypestring(PyArray_Descr *__pyx_v_descr, char *__pyx_v_f, char *__pyx_v_end, int *__pyx_v_offset) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":847
 * 
 *     cdef dtype child
 *     cdef int endian_detector = 1             # <<<<<<<<<<<<<<
 *     cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":848
 *     cdef dtype child
 *     cdef int endian_detector = 1
 *     cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)             # <<<<<<<<<<<<<<
 *     cdef tuple fields
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":851
 *     cdef tuple fields
 * 
 ...
 */
  ...
  for (;;) {
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":852
 * 
 *     for childname in descr.names:
 *         fields = descr.fields[childname]             # <<<<<<<<<<<<<<
 *         child, new_offset = fields
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":853
 *     for childname in descr.names:
 *         fields = descr.fields[childname]
 *         child, new_offset = fields             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":855
 *         child, new_offset = fields
 * 
 *         if (end - f) - <int>(new_offset - offset[0]) < 15:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (unlikely(__pyx_t_6)) {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":856
 * 
 *         if (end - f) - <int>(new_offset - offset[0]) < 15:
 *             raise RuntimeError(u"Format string allocated too short, see comment in numpy.pxd")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":858
 *             raise RuntimeError(u"Format string allocated too short, see comment in numpy.pxd")
 * 
 *         if ((child.byteorder == c'>' and little_endian) or             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":859
 * 
 *         if ((child.byteorder == c'>' and little_endian) or
 *             (child.byteorder == c'<' and not little_endian)):             # <<<<<<<<<<<<<<
 *             raise ValueError(u"Non-native byte order not supported")
 ...
 */
    if (unlikely(__pyx_t_6)) {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":860
 *         if ((child.byteorder == c'>' and little_endian) or
 *             (child.byteorder == c'<' and not little_endian)):
 *             raise ValueError(u"Non-native byte order not supported")             # <<<<<<<<<<<<<<
 *             # One could encode it in the format string and have Cython
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":870
 * 
 ...
 */
    while (1) {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":871
 *         # Output padding bytes
 *         while offset[0] < new_offset:
 *             f[0] = 120 # "x"; pad byte             # <<<<<<<<<<<<<<
 *             f += 1
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":872
 *         while offset[0] < new_offset:
 *             f[0] = 120 # "x"; pad byte
 *             f += 1             # <<<<<<<<<<<<<<
 *             offset[0] += 1
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":873
 *             f[0] = 120 # "x"; pad byte
 *             f += 1
 *             offset[0] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":875
 *             offset[0] += 1
 * 
 *         offset[0] += child.itemsize             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":877
 *         offset[0] += child.itemsize
 * 
 *         if not PyDataType_HASFIELDS(child):             # <<<<<<<<<<<<<<
 *             t = child.type_num
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":878
 * 
 *         if not PyDataType_HASFIELDS(child):
 *             t = child.type_num             # <<<<<<<<<<<<<<
 *             if end - f < 5:
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":879
 *         if not PyDataType_HASFIELDS(child):
 *             t = child.type_num
 *             if end - f < 5:             # <<<<<<<<<<<<<<
 *                 raise RuntimeError(u"Format string allocated too short.")
 ...
 */
      ...
      if (unlikely(__pyx_t_6)) {
        ...
        /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":880
 *             t = child.type_num
 *             if end - f < 5:
 *                 raise RuntimeError(u"Format string allocated too short.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":883
 * 
 *             # Until ticket #99 is fixed, use integers to avoid warnings
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":884
 *             # Until ticket #99 is fixed, use integers to avoid warnings
 *             if   t == NPY_BYTE:        f[0] =  98 #"b"
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"             # <<<<<<<<<<<<<<
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":885
 *             if   t == NPY_BYTE:        f[0] =  98 #"b"
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"             # <<<<<<<<<<<<<<
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":886
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"             # <<<<<<<<<<<<<<
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":887
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 *             elif t == NPY_INT:         f[0] = 105 #"i"             # <<<<<<<<<<<<<<
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":888
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 *             elif t == NPY_UINT:        f[0] =  73 #"I"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":889
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 *             elif t == NPY_LONG:        f[0] = 108 #"l"             # <<<<<<<<<<<<<<
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":890
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":891
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"             # <<<<<<<<<<<<<<
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":892
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"             # <<<<<<<<<<<<<<
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":893
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"             # <<<<<<<<<<<<<<
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":894
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":895
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"             # <<<<<<<<<<<<<<
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":896
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf             # <<<<<<<<<<<<<<
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":897
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd             # <<<<<<<<<<<<<<
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":898
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg             # <<<<<<<<<<<<<<
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":899
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":901
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"
 *             else:
 *                 raise ValueError(u"unknown dtype code in numpy.pxd (%d)" % t)             # <<<<<<<<<<<<<<
 *             f += 1
 ...
 */
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":902
 *             else:
 *                 raise ValueError(u"unknown dtype code in numpy.pxd (%d)" % t)
 *             f += 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":906
 *             # Cython ignores struct boundary information ("T{...}"),
 *             # so don't output it
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":907
 *             # so don't output it
 *             f = _util_dtypestring(child, f, end, offset)
 *     return f             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1022
...
static CYTHON_INLINE void __pyx_f_5numpy_set_array_base(PyArrayObject *__pyx_v_arr, PyObject *__pyx_v_base) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1023
 * 
 * cdef inline void set_array_base(ndarray arr, object base):
 *     Py_INCREF(base) # important to do this before stealing the reference below!             # <<<<<<<<<<<<<<
 *     PyArray_SetBaseObject(arr, base)
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1024
 * cdef inline void set_array_base(ndarray arr, object base):
 *     Py_INCREF(base) # important to do this before stealing the reference below!
 *     PyArray_SetBaseObject(arr, base)             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1026
 *     PyArray_SetBaseObject(arr, base)
 * 
 * cdef inline object get_array_base(ndarray arr):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_get_array_base(PyArrayObject *__pyx_v_arr) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1027
 * 
 * cdef inline object get_array_base(ndarray arr):
 *     base = PyArray_BASE(arr)             # <<<<<<<<<<<<<<
 *     if base is NULL:
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1028
 * cdef inline object get_array_base(ndarray arr):
 *     base = PyArray_BASE(arr)
 *     if base is NULL:             # <<<<<<<<<<<<<<
 *         return None
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1029
 *     base = PyArray_BASE(arr)
 *     if base is NULL:
 *         return None             # <<<<<<<<<<<<<<
 *     return <object>base
 ...
 */
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1030
 *     if base is NULL:
 *         return None
 *     return <object>base             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1034
 * # Versions of the import_* functions which are more suitable for
 * # Cython code.
...
static CYTHON_INLINE int __pyx_f_5numpy_import_array(void) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1035
 * # Cython code.
 * cdef inline int import_array() except -1:
 *     try:             # <<<<<<<<<<<<<<
 *         _import_array()
 ...
 */
  {
    ...
    /*try:*/ {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1036
 * cdef inline int import_array() except -1:
 *     try:
 *         _import_array()             # <<<<<<<<<<<<<<
 *     except Exception:
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1037
 *     try:
 *         _import_array()
 *     except Exception:             # <<<<<<<<<<<<<<
 *         raise ImportError("numpy.core.multiarray failed to import")
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1038
 *         _import_array()
 *     except Exception:
 *         raise ImportError("numpy.core.multiarray failed to import")             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1040
 *         raise ImportError("numpy.core.multiarray failed to import")
 * 
 * cdef inline int import_umath() except -1:             # <<<<<<<<<<<<<<
 *     try:
...
static CYTHON_INLINE int __pyx_f_5numpy_import_umath(void) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1041
 * 
 * cdef inline int import_umath() except -1:
 *     try:             # <<<<<<<<<<<<<<
 *         _import_umath()
 ...
 */
  {
    ...
    /*try:*/ {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1042
 * cdef inline int import_umath() except -1:
 *     try:
 *         _import_umath()             # <<<<<<<<<<<<<<
 *     except Exception:
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1043
 *     try:
 *         _import_umath()
 *     except Exception:             # <<<<<<<<<<<<<<
 *         raise ImportError("numpy.core.umath failed to import")
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1044
 *         _import_umath()
 *     except Exception:
 *         raise ImportError("numpy.core.umath failed to import")             # <<<<<<<<<<<<<<
 * 
...
/* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1046
 *         raise ImportError("numpy.core.umath failed to import")
 * 
 * cdef inline int import_ufunc() except -1:             # <<<<<<<<<<<<<<
 *     try:
...
static CYTHON_INLINE int __pyx_f_5numpy_import_ufunc(void) {
  ...
  /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1047
 * 
 * cdef inline int import_ufunc() except -1:
 *     try:             # <<<<<<<<<<<<<<
 *         _import_umath()
 ...
 */
  {
    ...
    /*try:*/ {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1048
 * cdef inline int import_ufunc() except -1:
 *     try:
 *         _import_umath()             # <<<<<<<<<<<<<<
 *     except Exception:
 ...
 */
    ...
    /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1049
 *     try:
 *         _import_umath()
 *     except Exception:             # <<<<<<<<<<<<<<
 *         raise ImportError("numpy.core.umath failed to import")
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "../new_python/lib/python3.4/site-packages/Cython/Includes/numpy/__init__.pxd":1050
 *         _import_umath()
 *     except Exception:
 *         raise ImportError("numpy.core.umath failed to import")             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pygofmm.mltools.algorithms.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pygofmm.mltools.algorithms.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pygofmm.mltools.algorithms.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pygofmm.mltools.algorithms._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_DKH, __pyx_k_DKH, sizeof(__pyx_k_DKH), 0, 0, 1, 1},
  {&__pyx_n_s_D_Data, __pyx_k_D_Data, sizeof(__pyx_k_D_Data), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_HDH, __pyx_k_HDH, sizeof(__pyx_k_HDH), 0, 0, 1, 1},
  {&__pyx_n_s_HDH_local, __pyx_k_HDH_local, sizeof(__pyx_k_HDH_local), 0, 0, 1, 1},
  {&__pyx_n_s_HKH, __pyx_k_HKH, sizeof(__pyx_k_HKH), 0, 0, 1, 1},
  {&__pyx_n_s_HKH_local, __pyx_k_HKH_local, sizeof(__pyx_k_HKH_local), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_KH_Data, __pyx_k_KH_Data, sizeof(__pyx_k_KH_Data), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_PyGOFMM, __pyx_k_PyGOFMM, sizeof(__pyx_k_PyGOFMM), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_classvec, __pyx_k_classvec, sizeof(__pyx_k_classvec), 0, 0, 1, 1},
  {&__pyx_n_s_cline_in_traceback, __pyx_k_cline_in_traceback, sizeof(__pyx_k_cline_in_traceback), 0, 0, 1, 1},
  {&__pyx_n_s_comm, __pyx_k_comm, sizeof(__pyx_k_comm), 0, 0, 1, 1},
  {&__pyx_kp_s_contiguous_and_direct, __pyx_k_contiguous_and_direct, sizeof(__pyx_k_contiguous_and_direct), 0, 0, 1, 0},
  {&__pyx_kp_s_contiguous_and_indirect, __pyx_k_contiguous_and_indirect, sizeof(__pyx_k_contiguous_and_indirect), 0, 0, 1, 0},
  {&__pyx_n_s_darr, __pyx_k_darr, sizeof(__pyx_k_darr), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_getGIDS, __pyx_k_getGIDS, sizeof(__pyx_k_getGIDS), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_k, __pyx_k_k, sizeof(__pyx_k_k), 0, 0, 1, 1},
  {&__pyx_n_s_local_ones, __pyx_k_local_ones, sizeof(__pyx_k_local_ones), 0, 0, 1, 1},
  {&__pyx_n_s_main, __pyx_k_main, sizeof(__pyx_k_main), 0, 0, 1, 1},
  {&__pyx_n_s_maxiter, __pyx_k_maxiter, sizeof(__pyx_k_maxiter), 0, 0, 1, 1},
  {&__pyx_n_s_memview, __pyx_k_memview, sizeof(__pyx_k_memview), 0, 0, 1, 1},
  {&__pyx_n_s_mode, __pyx_k_mode, sizeof(__pyx_k_mode), 0, 0, 1, 1},
  {&__pyx_n_s_n_local, __pyx_k_n_local, sizeof(__pyx_k_n_local), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_pygofmm_core, __pyx_k_pygofmm_core, sizeof(__pyx_k_pygofmm_core), 0, 0, 1, 1},
  {&__pyx_n_s_pygofmm_mltools_algorithms, __pyx_k_pygofmm_mltools_algorithms, sizeof(__pyx_k_pygofmm_mltools_algorithms), 0, 0, 1, 1},
  {&__pyx_kp_s_pygofmm_mltools_algorithms_pyx, __pyx_k_pygofmm_mltools_algorithms_pyx, sizeof(__pyx_k_pygofmm_mltools_algorithms_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_rids, __pyx_k_rids, sizeof(__pyx_k_rids), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_testparam, __pyx_k_testparam, sizeof(__pyx_k_testparam), 0, 0, 1, 1},
 ...
 *     testparam.finalize()
 */
  __pyx_tuple__28 = PyTuple_Pack(1, __pyx_n_s_testparam); if (unlikely(!__pyx_tuple__28)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__28);
  __Pyx_GIVEREF(__pyx_tuple__28);
  __pyx_codeobj__29 = (PyObject*)__Pyx_PyCode_New(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__28, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pygofmm_mltools_algorithms_pyx, __pyx_n_s_testFunction, 36, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__29)) __PYX_ERR(0, 36, __pyx_L1_error)
 ...
 *     N = K.getSize()
 */
  __pyx_tuple__30 = PyTuple_Pack(25, __pyx_n_s_K, __pyx_n_s_nclasses, __pyx_n_s_classvec, __pyx_n_s_maxiter, __pyx_n_s_N, __pyx_n_s_n_local, __pyx_n_s_c, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_comm, __pyx_n_s_cI, __pyx_n_s_rids, __pyx_n_s_local_ones, __pyx_n_s_Ones, __pyx_n_s_D, __pyx_n_s_H, __pyx_n_s_HKH_local, __pyx_n_s_HKH, __pyx_n_s_HDH_local, __pyx_n_s_HDH, __pyx_n_s_DKH, __pyx_n_s_H_Data, __pyx_n_s_D_Data, __pyx_n_s_KH_Data); if (unlikely(!__pyx_tuple__30)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__30);
  __Pyx_GIVEREF(__pyx_tuple__30);
  __pyx_codeobj__31 = (PyObject*)__Pyx_PyCode_New(4, 0, 25, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__30, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pygofmm_mltools_algorithms_pyx, __pyx_n_s_KMeans, 44, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__31)) __PYX_ERR(0, 44, __pyx_L1_error)
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("pygofmm.core"); if (unlikely(!__pyx_t_1)) __PYX_ERR(4, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_7pygofmm_4core_PyRuntime = __Pyx_ImportType(__pyx_t_1, "pygofmm.core", "PyRuntime", sizeof(struct __pyx_obj_7pygofmm_4core_PyRuntime), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_7pygofmm_4core_PyRuntime) __PYX_ERR(4, 19, __pyx_L1_error)
  __pyx_ptype_7pygofmm_4core_PyConfig = __Pyx_ImportType(__pyx_t_1, "pygofmm.core", "PyConfig", sizeof(struct __pyx_obj_7pygofmm_4core_PyConfig), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_7pygofmm_4core_PyConfig) __PYX_ERR(4, 22, __pyx_L1_error)
  __pyx_ptype_7pygofmm_4core_PyData = __Pyx_ImportType(__pyx_t_1, "pygofmm.core", "PyData", sizeof(struct __pyx_obj_7pygofmm_4core_PyData), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_7pygofmm_4core_PyData) __PYX_ERR(4, 26, __pyx_L1_error)
  __pyx_vtabptr_7pygofmm_4core_PyData = (struct __pyx_vtabstruct_7pygofmm_4core_PyData*)__Pyx_GetVtable(__pyx_ptype_7pygofmm_4core_PyData->tp_dict); if (unlikely(!__pyx_vtabptr_7pygofmm_4core_PyData)) __PYX_ERR(4, 26, __pyx_L1_error)
  __pyx_ptype_7pygofmm_4core_PyDistData_CBLK = __Pyx_ImportType(__pyx_t_1, "pygofmm.core", "PyDistData_CBLK", sizeof(struct __pyx_obj_7pygofmm_4core_PyDistData_CBLK), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_7pygofmm_4core_PyDistData_CBLK) __PYX_ERR(4, 30, __pyx_L1_error)
  __pyx_ptype_7pygofmm_4core_PyDistData_RBLK = __Pyx_ImportType(__pyx_t_1, "pygofmm.core", "PyDistData_RBLK", sizeof(struct __pyx_obj_7pygofmm_4core_PyDistData_RBLK), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_7pygofmm_4core_PyDistData_RBLK) __PYX_ERR(4, 34, __pyx_L1_error)
  __pyx_ptype_7pygofmm_4core_PyDistData_RIDS = __Pyx_ImportType(__pyx_t_1, "pygofmm.core", "PyDistData_RIDS", sizeof(struct __pyx_obj_7pygofmm_4core_PyDistData_RIDS), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_7pygofmm_4core_PyDistData_RIDS) __PYX_ERR(4, 38, __pyx_L1_error)
  __pyx_vtabptr_7pygofmm_4core_PyDistData_RIDS = (struct __pyx_vtabstruct_7pygofmm_4core_PyDistData_RIDS*)__Pyx_GetVtable(__pyx_ptype_7pygofmm_4core_PyDistData_RIDS->tp_dict); if (unlikely(!__pyx_vtabptr_7pygofmm_4core_PyDistData_RIDS)) __PYX_ERR(4, 38, __pyx_L1_error)
  __pyx_ptype_7pygofmm_4core_PyDistPairData = __Pyx_ImportType(__pyx_t_1, "pygofmm.core", "PyDistPairData", sizeof(struct __pyx_obj_7pygofmm_4core_PyDistPairData), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_7pygofmm_4core_PyDistPairData) __PYX_ERR(4, 44, __pyx_L1_error)
  __pyx_ptype_7pygofmm_4core_PyKernel = __Pyx_ImportType(__pyx_t_1, "pygofmm.core", "PyKernel", sizeof(struct __pyx_obj_7pygofmm_4core_PyKernel), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_7pygofmm_4core_PyKernel) __PYX_ERR(4, 47, __pyx_L1_error)
  __pyx_ptype_7pygofmm_4core_PyDistKernelMatrix = __Pyx_ImportType(__pyx_t_1, "pygofmm.core", "PyDistKernelMatrix", sizeof(struct __pyx_obj_7pygofmm_4core_PyDistKernelMatrix), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_7pygofmm_4core_PyDistKernelMatrix) __PYX_ERR(4, 50, __pyx_L1_error)
  __pyx_ptype_7pygofmm_4core_PyTreeKM = __Pyx_ImportType(__pyx_t_1, "pygofmm.core", "PyTreeKM", sizeof(struct __pyx_obj_7pygofmm_4core_PyTreeKM), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_7pygofmm_4core_PyTreeKM) __PYX_ERR(4, 56, __pyx_L1_error)
  __pyx_ptype_7pygofmm_4core_KernelMatrix = __Pyx_ImportType(__pyx_t_1, "pygofmm.core", "KernelMatrix", sizeof(struct __pyx_obj_7pygofmm_4core_KernelMatrix), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_7pygofmm_4core_KernelMatrix) __PYX_ERR(4, 62, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pygofmm__mltools__algorithms) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pygofmm.mltools.algorithms")) {
      if (unlikely(PyDict_SetItemString(modules, "pygofmm.mltools.algorithms", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pygofmm/mltools/algorithms.pyx":3
 * #Import from PyGOFMM
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_pygofmm_core, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_PyGOFMM, __pyx_t_2) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "pygofmm/mltools/algorithms.pyx":30
 * 
 * #Numpy
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "pygofmm/mltools/algorithms.pyx":32
 * import numpy as np
 * cimport numpy as np
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 *     testparam.finalize()
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_7pygofmm_7mltools_10algorithms_1testFunction, NULL, __pyx_n_s_pygofmm_mltools_algorithms); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_testFunction, __pyx_t_2) < 0) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     N = K.getSize()
 */
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(Py_None, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 44, __pyx_L1_error)
  __pyx_k_ = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_7pygofmm_7mltools_10algorithms_3KMeans, NULL, __pyx_n_s_pygofmm_mltools_algorithms); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_KMeans, __pyx_t_2) < 0) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "pygofmm/mltools/algorithms.pyx":1
 * #Import from PyGOFMM             # <<<<<<<<<<<<<<
 * cimport pygofmm.core as PyGOFMM
 * import pygofmm.core as PyGOFMM #I don't know what this is doing
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pygofmm.mltools.algorithms", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pygofmm.mltools.algorithms");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
