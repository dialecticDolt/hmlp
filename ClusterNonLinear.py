...
if args.file:
    ...
    for i in range(args.nclasses):
        ...
        if i%2 == 0:
            ...
            new_class =  np.random.randn(d, (int)(np.floor(N/args.nclasses))+split)
            new_class =  normalize(new_class, axis=0, norm='l2', copy=False) * (3)
...
k = args.k
nearest_neighbor_list = PyGOFMM.All_Nearest_Neighbors(comm, N, k, sources, leafnode=args.leaf)
